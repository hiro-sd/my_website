      ...
      <main>
        ...
        <section id="backgrounds" className="relative">
          <Box sx={{
            ...
            <h1 className="font-display-outline inline-block text-3xl sm:text-4xl bg-clip-text text-transparent bg-gradient-to-r from-purple-600 via-pink-600 to-purple-600 dark:from-purple-400 dark:via-pink-400 dark:to-purple-400 mb-12">Background</h1>
            <CourseTimeline />
          </Box>
        </section>
