...
const projects: Project[] = [
  {
    ...
    description: "Stay tuned for updates!", // This project explores the use of acoustic radiation pressure generated by ultrasound to levitate and manipulate spherical objects.
